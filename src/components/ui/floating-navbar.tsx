  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex flex-col items-center justify-between md:flex-row md:max-w-[90%] max-w-[94%] fixed sm:top-10 top-5 inset-x-0 mx-auto border rounded-4xl dark:bg-neutral-950 bg-white z-[50] px-8 py-3 overflow-hidden",
          className,
