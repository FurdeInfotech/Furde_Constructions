...
function WhyChooseUs() {
  return (
    <div className=" relative w-full md:h-[85vh] h-screen mt-5 rounded-4xl overflow-hidden ">
      <div className="absolute flex justify-center flex-col space-y-5 h-full w-full inset-0 bg-black/55 backdrop-blur-sm z-10 md:px-10 px-5">
        <h1 className=" font-bold md:text-2xl  text-lg text-white leading-snug heading">
          Why Choose Us?
        </h1>
