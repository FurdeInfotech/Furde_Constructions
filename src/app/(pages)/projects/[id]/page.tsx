...
import { MapPin, Download, ExternalLink, Phone, Mail, ArrowLeft } from "lucide-react";
        ...
        >
          ...
          {project.startingPrice && (
            <div className="text-center">
              ...
              <p className="text-3xl font-bold text-[#CA6F1E]">{project.startingPrice}</p>
            </div>
          )}
        </motion.div>
          ...
          {project.startingPrice && (
            <BlurFade delay={0.4}>
              <Card>
                ...
                <CardContent>
                  <p className="text-2xl font-bold text-[#CA6F1E]">{project.startingPrice}</p>
                </CardContent>
              </Card>
            </BlurFade>
          )}
        ...
        <BlurFade delay={0.5}>
          <Card>
            ...
            <CardContent>
              ...
              {project.badge && (
                <div className="mt-4">
                  <Badge variant="outline" className="text-[#CA6F1E] border-[#CA6F1E]">
                    {project.badge}
                  </Badge>
                </div>
              )}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="text-left">
                          <p className="font-medium">Project Brochure {index + 1}</p>
